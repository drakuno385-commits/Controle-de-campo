...
export default function SidebarBtn({ active, onClick, icon, label, small }: any) {
  return (
    <button onClick={onClick} className={`w-full flex items-center gap-4 ${small ? 'px-4 py-3 text-sm' : 'px-5 py-4 text-base'} rounded-xl font-bold transition-all duration-300 relative group overflow-hidden ${
